...
def detectar_posicion(mano1, mano2):
    global contador_juntas, contador_derecha_baja, contador_traslados, ultima_actualizacion, posiciones_previas
    ...
    # Guardar estado en archivo si ha pasado suficiente tiempo
    if estado and tiempo_actual - ultima_actualizacion > 1:  # Esperar al menos 1 segundo entre registros
        guardar_en_txt(estado)
